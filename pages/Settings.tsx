...
const Settings = () => {
  ...
  return (
    <div className="nl-page mx-auto max-w-5xl space-y-6">
      <header className="nl-page-header">
        <div>
          <p className="nl-eyebrow">Sistema</p>
          <h1 className="nl-title">Configurações</h1>
          <p className="nl-subtitle">Ajuste perfil, preferências da IA, módulos e personalização da empresa.</p>
        </div>
      </header>
      ...
      <section className="nl-card space-y-5 p-6">
        <h2 className="text-lg font-bold text-zinc-100">Perfil</h2>
      ...
      <section className="nl-card space-y-5 p-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-zinc-300">Tema atual: {theme === "dark" ? "Escuro" : "Claro"}</p>
          <button
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-zinc-300">Nível de detalhamento da IA</p>
          <select
            value={detailLevel}
            onChange={(e) => handleDetailChange(e.target.value as DetailLevel)}
            disabled={saving}
            className="nl-input max-w-[220px] font-bold"
          >
