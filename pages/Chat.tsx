...
const Chat = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] min-h-0 flex-col overflow-hidden bg-[#111613] rounded-3xl border border-white/[0.06] shadow-2xl relative">
      <header className="z-10 border-b border-white/[0.06] bg-[#111613]/80 backdrop-blur-md px-6 py-5">
      ...
      <div className="p-6 bg-[#111613]/80 backdrop-blur-md border-t border-white/[0.06]">
