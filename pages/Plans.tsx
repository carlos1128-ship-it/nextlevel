...
const Plans = () => {
  ...
  return (
    <div className="nl-page min-h-screen bg-[#050706] px-5 py-8 text-white">
      ...
      <div className="mx-auto max-w-7xl">
        <header className="nl-page-header border-b border-white/10 pb-7">
          <div>
            <p className="nl-eyebrow">NEXT LEVEL AI</p>
            <h1 className="nl-title">Escolha seu nível</h1>
            ...
            {isLoggedIn ? (
              ...
              {hasActiveSubscription ? (
                <button
                  ...
                  className="nl-button-secondary border-lime-300/40 text-lime-200 disabled:opacity-60"
                >
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-3">
          {orderedPlans.map((plan) => {
            ...
            return (
              <article
                key={plan.key}
                 className={`relative flex min-h-[520px] flex-col rounded-[20px] border p-6 ${
                  isSelected
