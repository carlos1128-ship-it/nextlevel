...
const BillingSuccess = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#030508] px-6 text-white">
      <div className="max-w-xl rounded-lg border border-lime-400/20 bg-white/[0.04] p-8 text-center shadow-[0_0_60px_rgba(182,255,0,0.08)]">
        <p className="text-[11px] font-black uppercase tracking-[0.28em] text-lime-300">
          Pagamento confirmado
        </p>
        <h1 className="mt-4 text-4xl font-black tracking-tight">
          Seu plano esta sendo ativado
        </h1>
        <p className="mt-4 text-sm leading-7 text-zinc-400">
          {active
            ? "Assinatura ativa. Redirecionando para o dashboard."
            : "Pagamento confirmado. Seu plano está sendo ativado."}
        </p>
