...
function MiniCard({
  ...
  return (
    <div className="min-h-[160px] rounded-3xl border border-zinc-800/90 bg-black/40 p-5">
...
export default function AiDashboardPanel({
  ...
  return (
    <section className="space-y-5 rounded-3xl border border-lime-400/20 bg-zinc-950 p-7">
